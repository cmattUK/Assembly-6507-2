...
Start:
	...
	clc 		; !!! We ALWAYS clear the carry flag before using ADC
				; ZERO POSITION (the first 256 bytes of memory) address means no '#' in front
	...
	sta $82		; Store the value of A in memory position $82
